...
import 'package:meteo_app/ui/home.dart';
...
class _WelcomeState extends State<Welcome> {
  ...
  Widget build(BuildContext context) {
    List<City> cities = City.citiesList.where((element) => element.isDefault == false).toList();
          ...
          return Container(
            ...
            child: Row(
              children: [
                ...
                Text(cities[index].city, style: TextStyle(fontSize: 16,
